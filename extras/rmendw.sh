...
# rmendw.sh
# This file is part of the YASUCE Project http://www.technobureau.com
#
# Yet Another SIP Unified Communication Engine - a fully featured software PBX and IVR
# Copyright (C) 2018 Ganapathi Chidambaram
#
